...
import wtf.fentanyl.event.impl.game.player.HitBlockEvent;
import wtf.fentanyl.event.impl.game.player.LivingUpdateEvent;
import wtf.fentanyl.event.impl.game.player.LeftClickMouseEvent;
import wtf.fentanyl.event.impl.game.player.MotionEvent;
import wtf.fentanyl.event.impl.game.player.MoveInputEvent;
import wtf.fentanyl.event.impl.game.player.RightClickMouseEvent;
import wtf.fentanyl.event.impl.game.player.SafeWalkEvent;
