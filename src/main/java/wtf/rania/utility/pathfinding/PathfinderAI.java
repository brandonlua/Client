package wtf.rania.utility.pathfinding;
...
public final class PathfinderAI {
    ...
    private static boolean isPointNotOkay(Point point) {
        final Block block = Minecraft.getMinecraft().theWorld.getBlockState(new net.minecraft.util.BlockPos(point.getPosX(), point.getPosY(), point.getPosZ())).getBlock();
