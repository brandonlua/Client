...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    {
        Client.BUS.post(new TickEvent(TickEvent.EventType.PRE));
        ...
        Client.BUS.post(new TickEvent(TickEvent.EventType.POST));
        ...
        if (this.currentScreen != null)
        {
            ...
            {
                CrashReport crashreport = CrashReport.makeCrashReport(throwable1, "Updating gui events");
                CrashReportCategory crashreportcategory = crashreport.makeCategory("Affected gui");
            ...
            if (this.currentScreen != null)
            {
                ...
                {
                    CrashReport crashreport1 = CrashReport.makeCrashReport(throwable, "Ticking gui");
                    CrashReportCategory crashreportcategory1 = crashreport1.makeCategory("Affected gui");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        //event key
                        Client.BUS.post(new EventKey(k));
            ...
            if (this.thePlayer.isUsingItem())
            {
                ...
                Animations animations = (Animations) Client.INSTANCE.getModuleManager().getModule(Animations.class);
                while (this.gameSettings.keyBindAttack.isPressed()) {
                    if (animations != null && animations.isToggled() && animations.getSwingWhileUsingItem().get()) {
