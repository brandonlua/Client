...
import wtf.fentanyl.util.animations.Translate;
...
public class NotificationManager {
    private final Deque<wtf.fentanyl.gui.notification.Notification> notifications = new ConcurrentLinkedDeque<>();
    ...
    public void post(NotificationType type, String title, String description) {
        post(new wtf.fentanyl.gui.notification.Notification(type, title, description));
    }

    public void post(NotificationType type, String title, String description, float time) {
        post(new wtf.fentanyl.gui.notification.Notification(type, title, description, time));
    }

    public void post(NotificationType type, String title) {
        post(new wtf.fentanyl.gui.notification.Notification(type, title, title));
    }

    private void post(wtf.fentanyl.gui.notification.Notification notification) {
    ...
    private void renderNotifications(ScaledResolution sr, boolean shader) {
        float yOffset = 0;
        for (wtf.fentanyl.gui.notification.Notification notification : getNotifications()) {
