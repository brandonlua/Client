    ...
    public void renderItem(EntityLivingBase entityIn, ItemStack heldStack, ItemCameraTransforms.TransformType transform) {
        if (heldStack != null) {
            ...
            if (this.itemRenderer.shouldRenderItemIn3D(heldStack)) {
                ...
                if (animations != null && animations.isToggled()) {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                } else if (abstractclientplayer.getItemInUseCount() > 0 || (aura != null && aura.isBlocking()) || (animations.isToggled() && animations.getBlockWhenSwing().get() && mc.thePlayer.isSwingInProgress)) {
                    ...
                    switch (enumaction) {
                        ...
                        case DRINK:
                            ...
                            this.transformFirstPersonItem(f, animations.isToggled() && animations.getOld().get() ? f1 : 0);
                            break;
                ...
                if (animations.isToggled() && animations.getOld().get() && !itemRenderer.shouldRenderItemIn3D(itemToRender)) {
