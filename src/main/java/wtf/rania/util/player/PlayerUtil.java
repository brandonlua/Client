...
public class PlayerUtil implements InstanceAccess {
    ...
    public static double calculatePerfectRangeToEntity(Entity entity) {
        ...
        double posY = entity.posY + entity.getEyeHeight() - 0.4D;
        double posZ = entity.posZ;

        float[] rotations = RotationUtil.getRotations(posX, posY, posZ);
        ...
        Vec3 rotationVector = new Vec3((double)(f1 * f2), (double)f3, (double)(f * f2));
