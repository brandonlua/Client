...
public class GuiShaders extends GuiScreenOF
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(201, l1, i2, k1 - 22 + 1, j, Lang.get("of.options.shader.shadersFolder")));
        ...
        this.buttonList.add(new GuiButton(203, k, this.height - 25, i, j, Lang.get("of.options.shader.shaderOptions")));
        this.updateButtons();
    }
