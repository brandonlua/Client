...
class GuiSlotShaders extends GuiSlot
{
    ...
    private boolean checkCompatible(IShaderPack sp, final int index)
    {
        ...
        {
            InputStream inputstream = sp.getResourceAsStream("/shader/shader.properties");
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        String s4 = I18n.format("of.message.shader.nv1", new Object[] {s3});
                        String s5 = I18n.format("of.message.shader.nv2", new Object[0]);
    ...
    protected void drawSlot(int index, int posX, int posY, int contentY, int mouseX, int mouseY)
    {
        ...
        if (s.equals("OFF"))
        {
            s = Lang.get("of.options.shader.packNone");
        }
        else if (s.equals("(internal)"))
        {
            s = Lang.get("of.options.shader.packDefault");
        }
