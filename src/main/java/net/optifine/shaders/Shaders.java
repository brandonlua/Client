...
public class Shaders
{
    ...
    public static final String PATH_SHADERS_PROPERTIES = "/shader/shader.properties";
    ...
    public static final boolean saveFinalShaders = System.getProperty("shader.debug.save", "false").equals("true");
    ...
    {
        SMCLog.info("Load shader configuration.");
    ...
    {
        SMCLog.info("Save shader configuration.");
    ...
    private static void loadShaderPackProperties()
    {
        ...
        if (shaderPack != null)
        {
            ...
            String s = "/shader/shader.properties";
    ...
    private static ICustomTexture loadCustomTextureRaw(int textureUnit, String line, String path, TextureType type, InternalFormat internalFormat, int width, int height, int depth, PixelFormat pixelFormat, PixelType pixelType)
    {
        try
        {
            String s = "shader/" + StrUtils.removePrefix(path, "/");
            InputStream inputstream = shaderPack.getResourceAsStream(s);
    ...
    public static ShaderOption[] getShaderPackOptions(String screenName)
    {
        ...
        {
            String s = screenName != null ? "gui." + screenName : "gui";
        ...
        try
        {
            ...
            for (int j = 0; j < afile.length; ++j)
            {
                ...
                if (file1.isDirectory())
                {
                    if (!s.equals("debug"))
                    {
                        File file2 = new File(file1, "shader");
    ...
    public static void checkShadersModInstalled()
    {
        ...
        throw new RuntimeException("Shaders Mod detected. Please remove it, OptiFine has built-in support for shader.");
    }
