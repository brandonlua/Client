...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private static final ResourceLocation[] shaderResourceLocations = new ResourceLocation[] {new ResourceLocation("shader/post/notch.json"), new ResourceLocation("shader/post/fxaa.json"), new ResourceLocation("shader/post/art.json"), new ResourceLocation("shader/post/bumpy.json"), new ResourceLocation("shader/post/blobs2.json"), new ResourceLocation("shader/post/pencil.json"), new ResourceLocation("shader/post/color_convolve.json"), new ResourceLocation("shader/post/deconverge.json"), new ResourceLocation("shader/post/flip.json"), new ResourceLocation("shader/post/invert.json"), new ResourceLocation("shader/post/ntsc.json"), new ResourceLocation("shader/post/outline.json"), new ResourceLocation("shader/post/phosphor.json"), new ResourceLocation("shader/post/scan_pincushion.json"), new ResourceLocation("shader/post/sobel.json"), new ResourceLocation("shader/post/bits.json"), new ResourceLocation("shader/post/desaturate.json"), new ResourceLocation("shader/post/green.json"), new ResourceLocation("shader/post/blur.json"), new ResourceLocation("shader/post/wobble.json"), new ResourceLocation("shader/post/blobs.json"), new ResourceLocation("shader/post/antialias.json"), new ResourceLocation("shader/post/creeper.json"), new ResourceLocation("shader/post/spider.json")};
    ...
    public void loadEntityShader(Entity entityIn)
    {
        if (OpenGlHelper.shadersSupported)
        {
            ...
            {
                this.loadShader(new ResourceLocation("shader/post/creeper.json"));
            }
            else if (entityIn instanceof EntitySpider)
            {
                this.loadShader(new ResourceLocation("shader/post/spider.json"));
            }
            else if (entityIn instanceof EntityEnderman)
            {
                this.loadShader(new ResourceLocation("shader/post/invert.json"));
            }
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (motionCameraModule != null && motionCameraModule.isToggled()) {
            ...
            prevRenderZ = prevRenderZ + (d2 - prevRenderZ) * motionCameraModule.interpolation.get();
        }
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                {
                    CrashReport crashreport = CrashReport.makeCrashReport(throwable, "Rendering gui");
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Client.BUS.post(new Event3D(partialTicks, new ScaledResolution(mc)));
    ...
    public boolean setFxaaShader(int p_setFxaaShader_1_)
    {
        ...
        {
            this.loadShader(new ResourceLocation("shader/post/fxaa_of_" + p_setFxaaShader_1_ + "x.json"));
